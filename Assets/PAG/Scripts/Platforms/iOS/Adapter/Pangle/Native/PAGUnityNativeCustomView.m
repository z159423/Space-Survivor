...
@interface PAGUnityNativeCustomView()
...
@implementation PAGUnityNativeCustomView
...
- (void)layoutSubviews {
    ...
    self.titleLabel.frame = CGRectMake(44, 0, CGRectGetWidth(self.bounds)-88, 20);
...
- (NSArray<UIView *> *)clickAbleViews {
    return @[self.relatedView.mediaView,self.titleLabel];
}
